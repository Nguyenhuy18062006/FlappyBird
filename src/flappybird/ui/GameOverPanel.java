...
public class GameOverPanel {
    ...
    public String getClickedButtonGameOver(int mouseX, int mouseY, int panelWidth, int panelHeight){
    ...
    public void drawGameOver(Graphics g, int panelWidth, int panelHeight, int score){
        ...
        g2.drawString(rankingTitle, rankingTitleX, menuY + 256);
        ...
        for(int i = 0; i < players.length; i++){
            int y = menuY + 285 + i * 20; // 285 là khoảng cách tự căn từ đỉnh menu đến chữ, còn i * 20 là i tăng để cho biết khoảng cách giữa các dòng
